	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>welcome<?php echo $_SESSION['login_user']; ?>
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<!-- Mega Menu -->
									<li >
										<a href="Islamic.html" >Islamic<b class="caret"></b></a>
									</li>
									<li >
										<a href="Children.html" >Children<b class="caret"></b></a>
									</li>
									<li >
										<a href="Narritive.html" >Narritive<b class="caret"></b></a>
									</li>
			...
			<div class="col-md-4 products-left">
				<div class="categories">
					...
					<ul class="cate">
						...
						<li><a href="Islamic.html"><i class="fa fa-arrow-right" aria-hidden="true" ></i>Islamic</a></li>
