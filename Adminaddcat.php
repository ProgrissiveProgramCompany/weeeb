	...
	<div class="register">
		<div class="container">
			...
			<div class="login-form-grids">	
				<h6>Catergory information</h6>
					<form action="addCat.php" method="post">
					<input type="text"  name="Name" placeholder="catergory Name" required=" " >	<br>
					<input type="number" name ="catergoryNum" placeholder="catergory" required=" " ><br><br>
