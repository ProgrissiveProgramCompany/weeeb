		...
		<div class="container">
			...
			<div class="product_list_header">
					<form action="#" method="post" class="last">
						...
						<button class="w3view-cart" type="submit" name="submit" value=""><li><a href="login.html">Logout</a></li></button>
					</form>
			</div>
...
<body>
	...
	while ($row = mysqli_fetch_array($query))
		{
        echo "<form id ='artisttable' action ='deletebook.php' method ='post'>";
			 echo "<tr>";
        echo "<td>" ."<input type='text'	class='fieldtext' name ='bid' value ='" . $row['cat'] . "' </td>";
        echo "<td>" . $row['bname'] . " </td>";
        echo "<td>"  . $row['b_publisher'] . " </td>";
        echo "<td>" . "<input type='submit' name ='update' value='delete'" . " </td>";
        echo "<td>" . "<input type='submit' name ='edit' value='edit'" . " </td>";
			/*echo '<form action="deletebook.php"><tr>
					
					<td>'.$row['bname'].'</td>
					<td> <name ="hidden" value="' . $row['bid'] . '"></td>"
					<td><input type="submit" name ="update" value="delete"></a></td>
			*/echo	"</tr>";
										echo "</form>";
